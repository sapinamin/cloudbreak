...
public class RecipeClusterTests extends CloudbreakTest {
    ...
    @Test (priority = 4)
    public void deleteValidRecipes() throws Exception {
        for (String recipe : RECIPE_NAMES) {
            given(Recipe.request()
                    .withName(recipe)
            );
    ...
    @Test (priority = 6)
    public void testTerminateFailedCluster() throws Exception {
        given(cloudProvider.aValidCredential());
    ...
    @Test (priority = 7)
    public void deleteInValidRecipe() throws Exception {
        given(Recipe.request()
                .withName(INVALID_RECIPE_NAME)
            );
        when(Recipe.delete());
